...
fig2_long <- tibble::tribble(
  ...
  "Pulmonary embolism",    "2007-2010",  "estimate",    1.0082847,
  "Pulmonary embolism",    "2007-2010",  "upper",        1.367315,
  "Pulmonary embolism",    "2007-2010",  "lower",        0.7435287,
  
  "Pulmonary embolism",    "2011-2014",  "estimate",   0.9422252,
  "Pulmonary embolism",    "2011-2014",  "upper",      1.350806,
  "Pulmonary embolism",    "2011-2014",  "lower",       0.6572284, 
  
  "Pulmonary embolism",    "2015-2018",  "estimate",    1.0483769,
  "Pulmonary embolism",    "2015-2018",  "upper",        1.473370,
  "Pulmonary embolism",    "2015-2018",  "lower",        0.7459729
...
shape_mapping <- c("Pulmonary embolism" = 19)  # Replace with actual levels and corresponding shapes


# Create plot
ggplot(fig2_wide, aes(x=Year, y=estimate, group=Status, color=Status, shape=Status)) + 
  
  ggtitle("IS risk in patients with a history of PE") +
  ...
  annotate("text", x = 0.70, y = 0.91, label = "Without PE",
...
pdf_file <- here("article2", "Figures", "Supplementaryfigure4.pdf")
png_file <- here("article2", "Figures", "Supplementaryfigure4.png")
tiff_file <- here("article2", "Figures", "Supplementaryfigure4.tiff")
jpeg_file <- here("article2", "Figures", "Supplementaryfigure4.jpeg")
