...
#  "Without anticoagulant", "2015-2018",  "lower",        0.9810564,
  ...
  "Any venous thromboembolism",    "2007-2010",  "estimate",    1.018767,
  "Any venous thromboembolism",    "2007-2010",  "upper",        1.254983,
  "Any venous thromboembolism",    "2007-2010",  "lower",        0.8270113,
  
  "Any venous thromboembolism",    "2011-2014",  "estimate",   1.048363,
  "Any venous thromboembolism",    "2011-2014",  "upper",      1.334322,
  "Any venous thromboembolism",    "2011-2014",  "lower",       0.8236882, 
  
  "Any venous thromboembolism",    "2015-2018",  "estimate",    1.025385,
  "Any venous thromboembolism",    "2015-2018",  "upper",        1.289891,
  "Any venous thromboembolism",    "2015-2018",  "lower",        0.8151181
...
shape_mapping <- c("Any venous thromboembolism" = 19)  # Replace with actual levels and corresponding shapes


# Create plot
ggplot(fig2_wide, aes(x=Year, y=estimate, group=Status, color=Status, shape=Status)) + 
  
  ggtitle("IS risk in patients with a history of any VTE") +
...
#  annotate("text", x = 1.5, y = 1.12, label = "anticoagulant use",
 ...
 #          family = "rosario") +
  ...
  annotate("text", x = 0.70, y = 0.91, label = "Without VTE",
  ...
  geom_segment(aes(x = 0.90, y = 0.929, xend = 1.20, yend = 0.993), 
               color = "black", 
               linetype = "solid", 
               size = 0.3) +
...
pdf_file <- here("article2", "Figures", "figure4.pdf")
png_file <- here("article2", "Figures", "figure4.png")
tiff_file <- here("article2", "Figures", "figure4.tiff")
jpeg_file <- here("article2", "Figures", "figure4.jpeg")
