...
#   "Pulmonary embolism",    "2007-2010",  "estimate",    55,
#   "Pulmonary embolism",    "2007-2010",  "upper",       60,
#   "Pulmonary embolism",    "2007-2010",  "lower",       50,
#   "Pulmonary embolism",    "2011-2014",  "estimate",    42,
#   "Pulmonary embolism",    "2011-2014",  "upper",       47,
#   "Pulmonary embolism",    "2011-2014",  "lower",       37,
#   "Pulmonary embolism",    "2015-2018",  "estimate",    35,
#   "Pulmonary embolism",    "2015-2018",  "upper",       39,
#   "Pulmonary embolism",    "2015-2018",  "lower",       31,
#   
#   "No pulmonary embolism", "2007-2010",  "estimate",    33,
#   "No pulmonary embolism", "2007-2010",  "upper",       36,
#   "No pulmonary embolism", "2007-2010",  "lower",       30,
#   "No pulmonary embolism", "2011-2014",  "estimate",    28,
#   "No pulmonary embolism", "2011-2014",  "upper",       31,
#   "No pulmonary embolism", "2011-2014",  "lower",       25,
#   "No pulmonary embolism", "2015-2018",  "estimate",    22,
#   "No pulmonary embolism", "2015-2018",  "upper",       25,
#   "No pulmonary embolism", "2015-2018",  "lower",       19
# )
...
fig2_long <- 
  structure(list(Status = c("Pulmonary embolism", "Pulmonary embolism", "Pulmonary embolism", 
                            "Pulmonary embolism", "Pulmonary embolism", "Pulmonary embolism", "Pulmonary embolism", 
                            "Pulmonary embolism", "Pulmonary embolism", "No pulmonary embolism", "No pulmonary embolism", 
                            "No pulmonary embolism", "No pulmonary embolism", "No pulmonary embolism", "No pulmonary embolism", 
                            "No pulmonary embolism", "No pulmonary embolism", "No pulmonary embolism"), 
                 ...
                 Value = c(3.175, 
                           4.291, 2.288, 2.123, 2.570, 1.737, 1.919, 2.231, 1.641, 
                           2.525, 2.612, 2.440, 1.867, 1.911, 1.824, 1.499, 1.530, 
                           1.467)), class = c("tbl_df", "tbl", "data.frame"), row.names = c(NA,  -18L))
...
shape_mapping <- c("Pulmonary embolism" = 19, "No pulmonary embolism" = 15)  # Replace with actual levels and corresponding shapes
...
ggplot(fig2_wide, aes(x=Year, y=estimate, group=Status, color=Status, shape=Status)) + 
  ...
  annotate("text", x = 2.3, y = 2.7, label = "Pulmonary embolism",
           size = 4.5, color="black", hjust = 0,
           family = "rosario") +
  annotate("text", x = 2.2, y = 1.2, label = "No pulmonary embolism",
           size = 4.5, color="black", hjust = 0,
           family = "rosario") +
...
pdf_file <- here("article2", "Figures", "Supplementaryfigure2.pdf")
png_file <- here("article2", "Figures", "Supplementaryfigure2.png")
tiff_file <- here("article2", "Figures", "Supplementaryfigure2.tiff")
jpeg_file <- here("article2", "Figures", "Supplementaryfigure2.jpeg")
